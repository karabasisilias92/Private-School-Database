...
namespace PrivateSchoolDatabase
{
    class PrivateSchool
    {
        ...
        public void Run()
        {
            string connectionString = @"Data Source=LAPTOP-D2QHH62D\SQLEXPRESS;Initial Catalog=PrivateSchool;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
